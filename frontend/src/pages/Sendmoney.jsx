                       ...
                       <div className=" flex justify-center items-center h-screen ">
                             ...
                             <div className="  h-96 w-96  bg-white-400 border rounded-md shadow-md" >
                                     ...
                                     <div className="  text-3xl font-medium text-center mt-4 mb-28 " >Send Money</div>
                                      ...
                                      <div>
                                          <input type="number" className="w-full border-black h-10 rounded-md mb-2 " />
                                      </div>


                                         <div>
                                            <button className=" w-full h-10 bg-green-500 shadow-md border rounded-md mt-2 " >Initiate Transfer</button>
                                         </div>
